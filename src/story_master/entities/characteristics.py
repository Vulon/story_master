...
SKILL_GROUPS = {
    ...
    CharacteristicType.DEXTERITY: [SkillType.ACROBATICS, SkillType.SLEIGHT_OF_HAND, SkillType.STEALTH],
    ...
    CharacteristicType.WISDOM: [SkillType.ANIMAL_HANDLING, SkillType.INSIGHT, SkillType.MEDICINE, SkillType.PERCEPTION, SkillType.SURVIVAL],
...
class Strength(Characteristic):
    name = CharacteristicType.STRENGTH
    skill_proficiencies = [SkillType.ATHLETICS]
    USE_CONDITION = """
...
For Tiny creatures, these values are halved"""
    ...
    def get_when_skill_can_be_used(self, skill: SkillType) -> str:
        if skill == SkillType.ATHLETICS:
            return Strength.ATHLETICS_CONDITION
        else:
            return None
...
class Dexterity(Characteristic):
    name = CharacteristicType.DEXTERITY
    skill_proficiencies = [SkillType.ACROBATICS, SkillType.SLEIGHT_OF_HAND, SkillType.STEALTH]
    USE_CONDITION = """
...
Make a Dexterity (Stealth) check when trying to hide from enemies, sneak past guards, escape unnoticed, or approach someone quietly and unseen."""
    ...
    ARMOR_CLASS = """Depending on the armor you wear, you can add your Dexterity modifier, or part of it, to your Armor Class."""
    ...
    def get_when_skill_can_be_used(self, skill: SkillType) -> str:
        if skill == SkillType.ACROBATICS:
            return self.ACROBATICS_CONDITION
        elif skill == SkillType.SLEIGHT_OF_HAND:
            return self.SLEIGHT_OF_HAND_CONDITION
        elif skill == SkillType.STEALTH:
            return self.STEALTH_CONDITION
        else:
            None
...
class Constitution(Characteristic):
    name = CharacteristicType.CONSTITUTION
    skill_proficiencies = []
    USE_CONDITION = """
...
class Intelligence(Characteristic):
    name = CharacteristicType.INTELLIGENCE
    skill_proficiencies = [SkillType.ARCANA, SkillType.HISTORY, SkillType.INVESTIGATION, SkillType.NATURE, SkillType.RELIGION]
    USE_CONDITION = """
    ...
    def get_when_skill_can_be_used(self, skill: SkillType) -> str:
        if skill == SkillType.INVESTIGATION:
            return self.INVESTIGATION_CONDITION
        elif skill == SkillType.HISTORY:
            return self.HISTORY_CONDITION
        elif skill == SkillType.ARCANA:
            return self.ARCANA_CONDITION
        elif skill == SkillType.NATURE:
            return self.NATURE_CONDITION
        elif skill == SkillType.RELIGION:
            return self.RELIGION_CONDITION
        else:
            return None
...
class Wisdom(Characteristic):
    name = CharacteristicType.WISDOM
    skill_proficiencies = [SkillType.ANIMAL_HANDLING, SkillType.INSIGHT, SkillType.MEDICINE, SkillType.PERCEPTION, SkillType.SURVIVAL]
    USE_CONDITION = """
    ...
    def get_when_skill_can_be_used(self, skill: SkillType) -> str:
        if skill == SkillType.ANIMAL_HANDLING:
            return self.ANIMAL_HANDLING_CONDITION
        elif skill == SkillType.INSIGHT:
            return self.INSIGHT_CONDITION
        elif skill == SkillType.MEDICINE:
            return self.MEDICINE_CONDITION
        elif skill == SkillType.PERCEPTION:
            return self.PERCEPTION_CONDITION
        elif skill == SkillType.SURVIVAL:
            return self.SURVIVAL_CONDITION
        else:
            return None
...
class Charisma(Characteristic):
    name = CharacteristicType.CHARISMA
    skill_proficiencies = [SkillType.DECEPTION, SkillType.INTIMIDATION, SkillType.PERFORMANCE, SkillType.PERSUASION]
    USE_CONDITION = """
